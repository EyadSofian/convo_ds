...
لا يوجد بعد دمج هويتين ولا معاينة دمج، ولا استيراد ولا تصدير، ولا وسوم ولا شرائح ولا حقول مخصّصة. ولا إسناد لموظّف آخر ولا تسليم مهمة ولا SLA — و`conversation.assign` صلاحية قائمة بلا واجهة، فالاستلام الذاتي هو الطريق الوحيد لتحرّك العمل، وذلك هو موضوع الشريحة التالية. وشاشات الحملات والتحليلات والإعدادات ما زالت بيانات عرض محلية وتقول ذلك. الدليل التفصيلي والمهمة التالية في [`docs/execution/current-task.md`](docs/execution/current-task.md).
