...
لا يوجد بعد دمج هويتين ولا معاينة دمج، ولا استيراد ولا تصدير ولا شرائح ولا SLA. وعميل Meta الحي يحتاج بيانات التطبيق والتوكن التي سيقدّمها مالك الحساب لاحقًا. وشاشات الحملات والتحليلات والإعدادات ما زالت بيانات عرض محلية وتقول ذلك. الدليل التفصيلي والمهمة التالية في [`docs/execution/current-task.md`](docs/execution/current-task.md).
