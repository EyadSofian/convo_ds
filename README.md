...
لا يوجد بعد دمج هويتين ولا معاينة دمج، ولا استيراد ولا تصدير، ولا وسوم ولا شرائح ولا حقول مخصّصة. ولا ملاحظات ولا SLA ولا تأجيل ولا إسناد للآخرين ولا عدّادات غير مقروء — كلها كانت مظاهر تجريبية بلا خادم، فأُزيلت بدل أن تبقى معطّلة. وشاشات الحملات والتحليلات والإعدادات ما زالت بيانات عرض محلية وتقول ذلك. الدليل التفصيلي والمهمة التالية في [`docs/execution/current-task.md`](docs/execution/current-task.md).
