...
لا يوجد بعد دمج هويتين ولا معاينة دمج، ولا استيراد ولا تصدير، ولا وسوم ولا شرائح ولا حقول مخصّصة، ولا SLA. وشاشات الحملات والتحليلات والإعدادات ما زالت بيانات عرض محلية وتقول ذلك. الدليل التفصيلي والمهمة التالية في [`docs/execution/current-task.md`](docs/execution/current-task.md).
